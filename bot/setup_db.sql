...
-- Tabela para capturar emails na Landing Page ANTES do Telegram
CREATE TABLE IF NOT EXISTS nc_leads (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  email TEXT NOT NULL UNIQUE,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- Habilitar RLS para permitir apenas inserts via serverless
ALTER TABLE nc_leads ENABLE ROW LEVEL SECURITY;
